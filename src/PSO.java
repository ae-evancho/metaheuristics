...
public class PSO implements Runnable  {
    ...
    public PSO(int a,double b,int c,double d,double e, int f, TextField r, TextField t,String p){
        this.p=p;
        nbrpopul=a;
        w=b;
        vmax=c;
    ...
    public PSO(int a,double b,int c,double d,double e, int f,String p){
        this.p=p;
        nbrpopul=a;
        w=b;
        vmax=c;
